  ...
  return (
    <>
      ...
      >
        ...
        >
          Creators can raise funds from their audience to support their projects
          or products.
      ...
      >
        ...
        >
          {[
            {
              question:
                "Can I raise funds for my project using Gumroad's crowdfunding program?",
              answer:
            ...
            {
              question:
                "Are there any fees for using Gumroad's crowdfunding program?",
              answer:
                "Gumroad deducts a small percentage of every sale, so you only pay when you earn.",
            },
            {
              question:
                "How can I get started with Gumroad's crowdfunding program?",
              answer:
