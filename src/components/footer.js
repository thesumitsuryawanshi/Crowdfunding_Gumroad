    ...
    >
      ...
      <Grid alignItems="center" xs={7} px={4} bgcolor="#000">
        <Card bgcolor="#000">
          ...
          >
            <Box p={6} display="flex" color="#fff" flexDirection="column">
              <Typography color="#fff">Help</Typography>

              <Typography color="#fff">Blog</Typography>
              <Typography color="#fff">Terms of Service</Typography>
            </Box>
            <Box m={6} p={6} display="flex" color="#fff" flexDirection="column">
              <Typography color="#fff">Privacy Policy</Typography>
              <Typography color="#fff">Features</Typography>
              <Typography color="#fff">Pricing</Typography>
              <Typography color="#fff">Discover</Typography>
              <Typography color="#fff">Discover</Typography>
              <Typography color="#fff">Jobs</Typography>
